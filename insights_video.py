...
def analyze_instagram_account():
    ...
    # Get user media (added media_product_type)
    ...
    total_saved = 0
    total_shares = 0
    total_views = 0  # Unified for videos/Reels (replaces plays/video_views)
        ...
        if insights:
            ...
            if media_type == 'VIDEO':
                ...
                if media_product_type == 'REELS':
                    ...
                    # Estimated completion (using views instead of deprecated plays)
                    if views > 0 and avg_watch_time > 0 and total_watch_time > 0:
                        ...
                        if estimated_duration > 0:
                            ...
                            print(f"📊 Watch Percentage: {completion_rate:.2f}%")  # Simplified to reuse calc
